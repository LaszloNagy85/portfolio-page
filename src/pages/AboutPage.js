...
const AboutPage = (props) => {
    ...
    return (
        <div>
            ...
            <Content>
                <p>Hello, my name is Laszlo Nagy. I'm a junior full stack developer with experience in Java, Spring Framework, Microservices, JPA, H2/Postgre SQL and React.</p>
                ...
                <p>My latest project, My Way, is a Community page for travellers made by our team of 3, fresh junior developers. You can check it out <a href="https://github.com/kadartibi/myway-backend" target="_blank" rel="noopener noreferrer">here</a>, or on the home page. It is built in Java, Spring, JPA, Microservices and React.</p>
                
                <p>My current project is SocialDistance, a little, but yet more useful app for the real friends, without all the unnecessary staff. Just friends. It's back-end is currently based on Google Firebase, coded in Node JS, and it's front-end will be React. Once it's ready and deployed, my plan is to recreate the back-end with Java and redeploy it.</p>
